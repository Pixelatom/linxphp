...
class loader
{
     ...
     * @var array
     */
    protected static $_classes_paths = array();
     ...
     */
    public static function add_class_path($name_patern='/(.+)/',$filename='$1.php',$directory='')
    {
     ...
     */
    public static function get_classes_paths()
    {
